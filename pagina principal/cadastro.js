...
auth.onAuthStateChanged((user) => {
    if (user) {
      ...
      // O usuário está logado, você pode exibir as informações ou carregar a página do carrinho
    } else {
      console.log("Usuário não logado");
      // O usuário não está logado, redireciona para login ou exibe mensagem
      window.location.href = "login.html";  // Ou qualquer outra página de sua escolha
    }
  });
