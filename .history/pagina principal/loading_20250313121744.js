...
function init() {
    ...
    loader.load('cuzin.obj', (object) => {
        ...
        // Quando o modelo estiver carregado, esconda a tela de carregamento
...
window.addEventListener('DOMContentLoaded', () => {
    document.getElementById('loading-screen').classList.remove('hidden'); // Mostra a tela de carregamento
    init();
});
