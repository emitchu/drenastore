...
function init() {
    ...
    // Adiciona o canvas 3D ao container do conteúdo
    const canvasContainer = document.getElementById('model3d-container');
    ...
    loader.load('cuzin2.obj', (object) => {
        ...
        setTimeout(() => {
            hideLoadingScreen();
        }, 3000); // Mantém a tela de carregamento por 3 segundos
    }, undefined, (error) => {
